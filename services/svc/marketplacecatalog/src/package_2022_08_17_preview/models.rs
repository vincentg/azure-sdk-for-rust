...
pub struct PlanMetadata {
    ...
    #[serde(rename = "relatedSkus", default, skip_serializing_if = "Vec::is_empty")]
...
pub struct PlanSummary {
    ...
    #[serde(rename = "purchaseDurationDiscounts", default, skip_serializing_if = "Vec::is_empty")]
...
pub struct ProductSummary {
    ...
    #[serde(rename = "vmImageGenerations", default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[serde(rename = "vmArchitectureTypes", default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[serde(rename = "ratingBuckets", default, skip_serializing_if = "Vec::is_empty")]
