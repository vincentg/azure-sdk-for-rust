...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TeamsUserAccessTokenRequest {
    #[doc = "AAD access token of a Teams User to acquire a new Communication Identity access token."]
    pub token: String,
}
impl TeamsUserAccessTokenRequest {
