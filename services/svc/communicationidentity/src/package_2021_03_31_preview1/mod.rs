...
pub mod communication_identity {
    ...
    impl Client {
        ...
        #[doc = "Exchange an AAD access token of a Teams user for a new ACS access token."]
        ...
        #[doc = "* `body`: Requesting scopes for the new token."]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2021-03-31-preview1");
