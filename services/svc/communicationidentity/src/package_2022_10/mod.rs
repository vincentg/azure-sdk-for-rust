...
pub mod communication_identity {
    ...
    impl Client {
        ...
        #[doc = "Exchange an Azure Active Directory (Azure AD) access token of a Teams user for a new Communication Identity access token with a matching expiration time."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `body`: Request payload for the token exchange."]
        pub fn exchange_teams_user_access_token(
            &self,
            body: impl Into<models::TeamsUserExchangeTokenRequest>,
    ...
    pub mod exchange_teams_user_access_token {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::TeamsUserExchangeTokenRequest,
        }
        impl RequestBuilder {
            #[doc = "Send the request and returns the response."]
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
