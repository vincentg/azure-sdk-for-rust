...
pub struct GuardrailsProfile {
    ...
    #[serde(rename = "systemExcludedNamespaces", default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[serde(rename = "excludedNamespaces", default, skip_serializing_if = "Vec::is_empty")]
